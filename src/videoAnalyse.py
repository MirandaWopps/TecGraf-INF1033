...
# Obter o caminho do vídeo do argumento da linha de comando
if len(sys.argv) > 1:
    video_path = sys.argv[1]
else:
    video_path = 'videoplayback.mp4'  # Padrão caso nenhum argumento seja passado

cap = cv2.VideoCapture(video_path)  # Usar o video_path aqui
